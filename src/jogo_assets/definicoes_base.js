...
const musica_0 = new Audio(`../musicas/Hellstorm.aac`);
const musica_1 = new Audio(`../musicas/Implicit Eyes.aac`);
const musica_2 = new Audio(`../musicas/Infamous King.aac`);
const musica_3 = new Audio(`../musicas/Pain Valley.aac`);
